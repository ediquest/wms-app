...
const dict = {
  en: {
    ...
    confirmClearAll: 'Clear all fields and all subsections?',
...
maxLenFlex: 'Max length: FLEX',
  ...
  pl: {
    ...
    confirmClearAll: '¿Borrar todos los campos y todas las subsecciones?',
    confirmClearAll: 'Na pewno wyczyścić pola i wszystkie podsekcje?',
...
it: {
  ...
  confirmDeleteInterface: 'Sei sicuro di voler eliminare questa interfaccia?',
    confirmClearAll: 'Cancellare tutti i campi e tutte le sottosezioni?',
