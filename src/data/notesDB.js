// Adapter: Notes Dock API on top of unified app DB
import { db as appDB } from '../db/appDB.js';
export const notesDB = appDB;
export const db = notesDB;

// --- Added by migration: subValues for form subsections ---
